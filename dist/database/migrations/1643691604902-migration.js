...
exports.migration1643691604902 = void 0;
class migration1643691604902 {
    constructor() {
        this.name = 'migration1643691604902';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`todo\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, \`contents\` text NOT NULL, \`started_at\` timestamp NULL, \`finished_at\` timestamp NULL, \`completed_at\` timestamp NULL, \`user_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`review\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, \`contents\` text NOT NULL, \`started_at\` timestamp NULL, \`finished_at\` timestamp NULL, \`user_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
...
exports.migration1643691604902 = migration1643691604902;
//# sourceMappingURL=1643691604902-migration.js.map